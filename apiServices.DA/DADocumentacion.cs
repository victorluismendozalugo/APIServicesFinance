    ...
    public class DADocumentacion
    {
        ...
        public Result<DataModel> GuardarDocumentacion(DocumentacionModel usuario)
        {
            ...
            try
            {
                ...
                parametros.Add("@pVerificador", ConexionDbType.VarChar, usuario.Verificador);
        ...
        public Result<DataModel> ConsultaClientesXTipoDocumentacion(string usuario, int sucursal, int tipoCliente)
        {
            ...
            try
            {
                ...
                var r = _conexion.ExecuteWithResults<DocumentacionModel>("procClientesXTipoDocumentacionCon2", parametros);
        ...
        public Result<DataModel> ObtieneComprobantesCliente(string usuario, int sucursal)
        {
            var parametros = new ConexionParameters();
            try
            {
                ...
                var r = _conexion.ExecuteWithResults<DocumentacionModel2>("procClientesXTipoDocumentacionCon3", parametros);
        ...
        public Result<DataModel> SolicitudesGuardar(SolicitudesModel solicitud)
        {
            var parametros = new ConexionParameters();
            try
            {
                parametros.Add("@pSucursal", ConexionDbType.Int, solicitud.Sucursal);
                parametros.Add("@pUsuario", ConexionDbType.VarChar, solicitud.Usuario);
                parametros.Add("@pSolicitud", ConexionDbType.VarChar, solicitud.Solicitud);
                parametros.Add("@pResponsable", ConexionDbType.VarChar, solicitud.Responsable);

                parametros.Add("@pResultado", ConexionDbType.Bit, System.Data.ParameterDirection.Output);
                parametros.Add("@pMsg", ConexionDbType.VarChar, 300, System.Data.ParameterDirection.Output, 300);
                parametros.Add("@pCodError", ConexionDbType.Int, System.Data.ParameterDirection.Output);

                var r = _conexion.Execute("procSolicutudesGuardar", parametros);
            ...
            catch (Exception ex)
            {
                ...
                {
                    Value = false,
                    Message = "Problemas al guardar la solicitud",
                    Data = new DataModel()
                    {
                        CodigoError = 101,
                        MensajeBitacora = ex.Message,
        ...
        public Result<DataModel> SolicitudesCon(SolicitudesModel solicitud)
        {
            var parametros = new ConexionParameters();
            try
            {
                ...
                var r = _conexion.ExecuteWithResults<SolicitudesModel>("procSolicutudesCon", parametros);
